    ...
    <section className="min-h-screen bg-gradient-to-br from-blue-300 to-white flex items-center justify-center py-10 px-4">
      <div className="max-w-xl mx-auto bg-white p-8 shadow-xl rounded-lg my-20">
        <form onSubmit={handleFormSubmit} className="space-y-6">
          ...
          <button type="submit" className="w-full bg-blue-500 text-white py-3 rounded-md hover:bg-blue-600 transition-all duration-200">Send</button>
        </form>
        <div className="text-center mt-6 space-y-3">
          <NavLink to="/">
            <button className="bg-red-500 text-white px-6 py-2 rounded-xl hover:bg-red-600">⬅️ Go Back</button>
          </NavLink>
          </div>
        </div>
    </section>
