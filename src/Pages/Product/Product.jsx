    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-300 to-white px-4 py-10 my-18">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-8">
          <NavLink to="/">
            <button className="bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-xl shadow transition">⬅️ Go Back</button>
          </NavLink>
          <div className="flex flex-col sm:flex-row items-center gap-3">
            ...
            <NavLink
              to="/add-product"
              className="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-5 py-2 rounded-xl shadow transition duration-200"
            > ✚ Add Product</NavLink>
          </div>
        </div>
